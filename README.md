...
- **Обзор мирового рынка:** Отображает ключевые глобальные метрики криптовалютного рынка (рыночная капитализация, объем за 24 часа, доминирование BTC) с 24-часовыми изменениями и цветовым кодированием при запуске приложения.
